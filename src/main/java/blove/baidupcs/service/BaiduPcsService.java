...
public interface BaiduPcsService {
	...
	@Multipart
	@POST("/file")
	CreateFileResponse createSuperFile(@Query("method") String method, @Query("access_token") String accessToken,
			@Query("path") String path, @Part("param") CreateSuperFileParam param, @Query("ondup") String ondup)
			throws Throwable;
	 ...
	 */
	@GET("/file")
	MetaBatchResponse meta(@Query("method") String method, @Query("access_token") String accessToken,
	 ...
	 *             JSON字符串。<br>
	 *             {"list":[{"path":
	 *             "\/apps\/album\/a\/b\/c"},{"path":"\/apps\/album\/a\/b\/d"}]
	 *             }<br>
	 *             注意：<br>
	 *             <li>路径长度限制为1000<br> <li>路径中不能包含以下字符：\\ ? | " > < : *<br> <li>
	 *             文件名或路径名开头结尾不能是“.”或空白字符，空白字符包括: \r, \n, \t, 空格, \0, \x0B
	...
	@Multipart
	@POST("/file")
	MetaBatchResponse metaBatch(@Query("method") String method, @Query("access_token") String accessToken,
	...
	@Multipart
	@POST("/file")
	CopyOrMoveResponse move(@Query("method") String method, @Query("access_token") String accessToken,
	...
	@Multipart
	@POST("/file")
	CopyOrMoveResponse moveBatch(@Query("method") String method, @Query("access_token") String accessToken,
	...
	@Multipart
	@POST("/file")
	CopyOrMoveResponse copy(@Query("method") String method, @Query("access_token") String accessToken,
			@Part("from") String from, @Part("to") String to) throws Throwable;
	...
	@Multipart
	@POST("/file")
	CopyOrMoveResponse copyBatch(@Query("method") String method, @Query("access_token") String accessToken,
			@Part("param") MoveBatchOrCopyBatchParam param) throws Throwable;
	...
	@Multipart
	@POST("/file")
	BasicResponse deleteBatch(@Query("method") String method, @Query("access_token") String accessToken,
			@Part("param") PathListParam param) throws Throwable;
	 ...
	 */
	@GET("/file")
	ListOrSearchResponse search(@Query("method") String method, @Query("access_token") String accessToken,
			@Query("path") String path, @Query("wd") String wd, @Query("re") String re) throws Throwable;
	 ...
	 */
	@GET("/thumbnail")
	Response generateThumbnail(@Query("method") String method, @Query("access_token") String accessToken,
			@Query("path") String path, @Query("quality") Integer quality, @Query("height") Integer height,
			@Query("width") Integer width) throws Throwable;
	 ...
	 */
	@GET("/file")
	DiffResponse diff(@Query("access_token") String accessToken, @Query("method") String method,
			@Query("cursor") String cursor) throws Throwable;
	 ...
	 */
	@GET("/file")
	Response streaming(@Query("method") String method, @Query("access_token") String accessToken,
			@Query("path") String path, @Query("type") String type) throws Throwable;
	 ...
	 */
	@GET("/stream")
	ListStreamResponse listStream(@Query("method") String method, @Query("access_token") String accessToken,
			@Query("type") String type, @Query("start") String start, @Query("limit") String limit,
			@Query("filter_path") String filter_path) throws Throwable;

	/**
	 * 秒传一个文件。<br>
	 * 注意： <li>被秒传文件必须大于256KB（即 256*1024 B）。 <li>校验段为文件的前256KB，秒传接口需要提供校验段的MD5。
	 * <br>
	 * (非强一致接口，上传后请等待1秒后再读取)
	 * 
	 * @param method
	 ...
	 */
	@GET("/file")
	CreateFileResponse rapidUpload(@Query("method") String method, @Query("access_token") String accessToken,
			@Query("path") String path, @Query("content-length") Long contentLength,
			@Query("content-md5") String contentMD5, @Query("slice-md5") String sliceMD5,
			@Query("content-crc32") String contentCRC32, @Query("ondup") String ondup) throws Throwable;
	...
	CloudDownloadAddTaskResponse cloudDownloadAddTask(@Query("method") String method,
			@Query("access_token") String accessToken, @Query("expires") Integer expires,
			@Query("save_path") String savePath, @Query("source_url") String sourceUrl,
			@Query("rate_limit") Integer rateLimit, @Query("timeout") Integer timeout,
	 ...
	 */
	@GET("/services/cloud_dl")
	CloudDownloadQueryTaskResponse cloudDownloadQueryTask(@Query("method") String method,
			@Query("access_token") String accessToken, @Query("expires") Integer expires,
			@Query("task_ids") String taskIDs, @Query("op_type") Integer opType) throws Throwable;
	 ...
	 */
	@GET("/services/cloud_dl")
	CloudDownloadListTaskResponse cloudDownloadListTask(@Query("method") String method,
			@Query("access_token") String accessToken, @Query("expires") Integer expires,
			@Query("start") Integer start, @Query("limit") Integer limit, @Query("asc") Integer asc,
			@Query("source_url") String sourceUrl, @Query("save_path") String savePath,
			@Query("create_time") Integer createTime, @Query("status") Integer status,
	 ...
	 */
	@GET("/services/cloud_dl")
	BasicResponse cloudDownloadCancelTask(@Query("method") String method, @Query("access_token") String accessToken,
			@Query("expires") Integer expires, @Query("task_id") String taskID) throws Throwable;
	 ...
	 */
	@GET("/file")
	ListOrSearchResponse listRecycle(@Query("method") String method, @Query("access_token") String accessToken,
			@Query("start") Integer start, @Query("limit") Integer limit) throws Throwable;
	 ...
	 */
	@GET("/file")
	RestoreResponse restore(@Query("method") String method, @Query("access_token") String accessToken,
	 ...
	 */
	@GET("/file")
	RestoreResponse restoreBatch(@Query("method") String method, @Query("access_token") String accessToken,
	 ...
	 */
	@GET("/file")
	BasicResponse clearRecycle(@Query("method") String method, @Query("access_token") String accessToken,
