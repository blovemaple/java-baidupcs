...
public interface BaiduPcsAuthService {
	 ...
	 */
	@GET("/device/code")
	DeviceCodeResponse deviceCode(@Query("client_id") String clientId, @Query("response_type") String responseType,
			@Query("scope") String scope) throws Throwable;
	 ...
	 */
	@GET("/token")
	TokenResponse deviceToken(@Query("grant_type") String grantType, @Query("code") String code,
			@Query("client_id") String clientId, @Query("client_secret") String clientSecret) throws Throwable;
	 ...
	 */
	@GET("/token")
	TokenResponse refreshToken(@Query("grant_type") String grantType, @Query("refresh_token") String refreshToken,
